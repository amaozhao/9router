...
console.log("📦 Building LaziRouter CLI package with Next.js...\n");
...
// Strip better-sqlite3 (native) — it lives in ~/.lazirouter/runtime to avoid
...
if (fs.existsSync(betterDir)) {
  ...
  console.log("✅ Stripped better-sqlite3 (lives in ~/.lazirouter/runtime)");
}
console.log("");
