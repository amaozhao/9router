...
const APP_NAME = "lazirouter";
const APP_LABEL = "com.lazirouter.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when lazirouter is currently
 ...
 * SIGTERM to the running process. When the running lazirouter cli.js was itself
...
<dict>
    ...
    <string>/tmp/lazirouter.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/lazirouter.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `lazirouter.cmd` lookup that depended on the npm prefix path.
