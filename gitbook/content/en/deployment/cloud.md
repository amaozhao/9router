...
Deploy LaziRouter on VPS or Docker for remote access and production use.
...
| `DATA_DIR` | `~/.lazirouter` | Database and data storage path |
...
Create `/etc/nginx/sites-available/lazirouter`:
