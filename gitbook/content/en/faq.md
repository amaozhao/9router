...
Common questions about LaziRouter.

---

## What is LaziRouter?

**LaziRouter is an AI model router that maximizes your subscription value and minimizes costs.**
...
**LaziRouter uses a 3-tier pricing strategy:**
...
**Yes, LaziRouter itself is 100% free and open source.**
...
**Yes! This is LaziRouter's core feature.**
...
**LaziRouter tracks quota in real-time for all providers:**
...
## Can I self-host LaziRouter?

**Yes! LaziRouter supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `~/.lazirouter`)
...
**Yes, LaziRouter prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `~/.lazirouter` (or custom `DATA_DIR`)
- No data sent to LaziRouter servers
...
**What LaziRouter stores:**
- Provider OAuth tokens (encrypted)
- API keys (encrypted)
- Usage statistics (local only)
- Combo configurations

**What LaziRouter does NOT store:**
...
**Breaking changes:**
- Check [CHANGELOG.md](https://github.com/decolua/lazirouter/blob/main/CHANGELOG.md)
- Backup `~/.lazirouter` before major updates
...
See [CONTRIBUTING.md](https://github.com/decolua/lazirouter/blob/main/CONTRIBUTING.md) for details.
