...
Detailed installation guide for LaziRouter with troubleshooting tips.
...
Install LaziRouter globally to use from anywhere:
...
- ✅ Simple command: `lazirouter`
- ✅ Auto-updates with `npm update -g lazirouter`
...
3. Data directory created at `~/.lazirouter`
...
**Issue:** LaziRouter using too much RAM
