...
Integrate LaziRouter with Claude Code CLI to route your Anthropic API requests through LaziRouter's intelligent routing system.
...
Claude Code supports the following model aliases that map to LaziRouter models:
