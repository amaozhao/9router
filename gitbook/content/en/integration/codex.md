...
Integrate LaziRouter with OpenAI Codex CLI to route your OpenAI API requests through LaziRouter's intelligent routing system.
...
LaziRouter provides the following Codex models:
...
1. Verify your API key is correct in LaziRouter dashboard
...
1. Verify the model name matches your LaziRouter configuration
2. Check that the OpenAI provider connection is active in LaziRouter dashboard
...
Make sure you have configured your API key in the LaziRouter cloud dashboard.
