...
Integrate LaziRouter with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- LaziRouter API key from [dashboard](https://lazirouter.com/dashboard)
- LaziRouter running (local or cloud)
...
### 2. Add LaziRouter Model Configuration
...
3. Choose your preferred LaziRouter model
...
- Check network latency to LaziRouter
