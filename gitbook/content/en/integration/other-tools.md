...
LaziRouter is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

LaziRouter provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to LaziRouter using these settings:

**Local LaziRouter:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: any LaziRouter model (cc/*, cx/*, glm/*, etc.)
```
...
**Problem:** Cannot connect to LaziRouter
```bash
...
- Check network connection to LaziRouter
