...
Common issues and solutions when using LaziRouter.
...
1. **Auto-refresh (default):**
   LaziRouter automatically refreshes tokens. Wait 30 seconds and retry.
...
1. **Check if LaziRouter is running:**
   ```bash
   # Check process
