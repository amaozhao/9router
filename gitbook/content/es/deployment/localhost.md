...
Ejecuta LaziRouter en tu máquina local para desarrollo y uso personal.

---

## 📦 Instalación

Instala LaziRouter globalmente vía npm:
...
Inicia LaziRouter con un solo comando:
...
- **Directorio de datos**: `~/.lazirouter`
...
Presiona `Ctrl+C` en la terminal donde LaziRouter se está ejecutando.

```bash
# En la terminal ejecutando lazirouter
^C  # Presiona Ctrl+C
```
