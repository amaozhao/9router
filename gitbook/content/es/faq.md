...
Preguntas comunes sobre LaziRouter.

---

## ¿Qué es LaziRouter?

**LaziRouter es un router de modelos de IA que maximiza el valor de tu suscripción y minimiza los costos.**
...
**LaziRouter usa una estrategia de precios de 3 niveles:**
...
## ¿LaziRouter es gratis?

**Sí, LaziRouter en sí es 100% gratis y open source.**
...
**¡Sí! Esta es la característica principal de LaziRouter.**
...
**LaziRouter rastrea la cuota en tiempo real para todos los proveedores:**
...
## ¿LaziRouter funciona con Cursor?

**Sí, pero Cursor requiere un endpoint en la nube.**

**Problema:** Cursor IDE no soporta endpoints en localhost.

**Solución:** Usa el despliegue en la nube de LaziRouter:

```
Cursor Settings → Models → Advanced:
  OpenAI API Base URL: https://lazirouter.com/v1
...
## ¿Puedo auto-hospedar LaziRouter?

**¡Sí! LaziRouter soporta múltiples opciones de despliegue:**
...
- `DATA_DIR` - Ruta de almacenamiento de la base de datos (por defecto: `~/.lazirouter`)
...
**Sí, LaziRouter prioriza la seguridad y privacidad:**

**Almacenamiento local:**
- Todos los datos se almacenan localmente en `~/.lazirouter` (o `DATA_DIR` personalizado)
- No se envían datos a los servidores de LaziRouter
...
**Cambios disruptivos:**
- Revisa [CHANGELOG.md](https://github.com/decolua/lazirouter/blob/main/CHANGELOG.md)
- Respalda `~/.lazirouter` antes de actualizaciones mayores
...
1. **Reportar bugs:**
   - [GitHub Issues](https://github.com/decolua/lazirouter/issues)
   - Incluye logs de error, pasos para reproducir

2. **Solicitar características:**
   - [GitHub Discussions](https://github.com/decolua/lazirouter/discussions)
   - Describe el caso de uso y los beneficios

3. **Enviar código:**
   ```bash
   # Fork del repo
   git clone https://github.com/YOUR_USERNAME/lazirouter.git
   cd lazirouter
...
Consulta [CONTRIBUTING.md](https://github.com/decolua/lazirouter/blob/main/CONTRIBUTING.md) para detalles.

---

## ¿Necesitas más ayuda?

- **Documentación:** [lazirouter.com/docs](https://lazirouter.com/docs)
