...
Pon en marcha LaziRouter en 5 minutos y comienza a enrutar solicitudes de IA de forma inteligente.
...
Apunta tu herramienta de codificación a LaziRouter:
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [desde el dashboard de lazirouter]
