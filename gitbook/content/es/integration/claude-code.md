...
Integra LaziRouter con Claude Code CLI para enrutar tus solicitudes de la API de Anthropic a través del sistema de enrutamiento inteligente de LaziRouter.
...
Claude Code soporta los siguientes aliases de modelos que mapean a modelos de LaziRouter:
...
```bash
export ANTHROPIC_BASE_URL="https://lazirouter.com"
```
