...
Integra LaziRouter con la extensión Cline de VSCode para enrutar tus solicitudes de IA a través del sistema de enrutamiento inteligente de LaziRouter.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Cline instalada desde el marketplace de VSCode
- LaziRouter ejecutándose localmente o endpoint en la nube configurado
...
Establece la URL base a tu endpoint de LaziRouter:

**Para LaziRouter local:**
```
http://localhost:20128/v1
```

**Para LaziRouter en la nube:**
```
https://lazirouter.com
```

**Pasos:**
1. En el campo **Base URL**, ingresa tu endpoint de LaziRouter
...
3. La key debe comenzar con `sk-lazirouter-`

### 5. Seleccionar modelo

1. En el dropdown **Model**, puedes:
   - Seleccionar de los modelos disponibles (si Cline los auto-detecta)
   - Ingresar manualmente el nombre del modelo desde tu configuración de LaziRouter
...
4. Cline usará LaziRouter para procesar tu solicitud

### Generación de código

1. Pide a Cline que genere código: "Create a React component for a login form"
2. Cline generará código usando LaziRouter
...
3. Obtén explicaciones potenciadas por IA a través de LaziRouter

### Operaciones con archivos

1. Pide a Cline que cree, modifique o elimine archivos
2. Cline usará LaziRouter para entender el contexto y hacer cambios
...
1. Verifica que LaziRouter esté corriendo: `curl http://localhost:20128/health`
...
2. Verifica que tu instancia de LaziRouter esté ejecutándose y saludable
3. Intenta recargar la ventana de VSCode (Cmd/Ctrl + Shift + P → "Reload Window")
4. Revisa los logs de LaziRouter para cualquier error

## Configuración avanzada

### Usar endpoint en la nube

Para usar el endpoint en la nube de LaziRouter en lugar de localhost:

1. En la configuración de Cline, establece Base URL a: `https://lazirouter.com`
2. Asegúrate de haber configurado tu API key en el dashboard en la nube de LaziRouter
...
## Integración con características de LaziRouter

### Enrutamiento de modelos

LaziRouter enruta automáticamente tus solicitudes al mejor proveedor disponible según:
...
Si un proveedor falla, LaziRouter automáticamente cambia a proveedores alternativos configurados en tu dashboard.

### Seguimiento de uso

Monitorea tu uso de Cline a través del dashboard de LaziRouter:
