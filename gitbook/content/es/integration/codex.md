...
Integra LaziRouter con OpenAI Codex CLI para enrutar tus solicitudes de la API de OpenAI a través del sistema de enrutamiento inteligente de LaziRouter.
...
LaziRouter proporciona los siguientes modelos de Codex:
...
```json
{
  ...
  "apiKey": "your-lazirouter-api-key",
...
1. Verifica que tu API key sea correcta en el dashboard de LaziRouter
...
1. Verifica que el nombre del modelo coincida con tu configuración de LaziRouter
2. Verifica que la conexión del proveedor de OpenAI esté activa en el dashboard de LaziRouter
...
```bash
export OPENAI_BASE_URL="https://lazirouter.com"
```

Asegúrate de haber configurado tu API key en el dashboard en la nube de LaziRouter.
