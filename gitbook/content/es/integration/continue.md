...
Integra LaziRouter con la extensión Continue para llevar la asistencia de IA directamente a Visual Studio Code.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Continue instalada desde el marketplace de VSCode
- API key de LaziRouter desde el [dashboard](https://lazirouter.com/dashboard)
- LaziRouter ejecutándose (local o en la nube)
...
### 2. Agregar configuración de modelo de LaziRouter
...
```json
{
  "models": [
    {
      "title": "LaziRouter - Claude Opus (Best)",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key-from-dashboard",
      "apiBase": "http://localhost:20128/v1"
    ...
    {
      "title": "LaziRouter - Claude Sonnet (Balanced)",
      "provider": "openai",
    ...
    {
      "title": "LaziRouter - DeepSeek Chat (Code)",
      "provider": "openai",
    ...
    {
      "title": "LaziRouter - Claude Haiku (Fast)",
      "provider": "openai",
...
```json
"apiBase": "https://lazirouter.com/v1"
```
...
3. Elige tu modelo preferido de LaziRouter
...
```json
{
  "models": [
    {
      "title": "LaziRouter - Creative Writer",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key",
      "apiBase": "http://localhost:20128/v1",
...
- Verifica que LaziRouter esté corriendo: `curl http://localhost:20128/health`
...
- Selecciona el modelo correcto de LaziRouter
...
- Verifica la latencia de red hacia LaziRouter
