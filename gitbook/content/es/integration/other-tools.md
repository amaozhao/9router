...
LaziRouter es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

LaziRouter proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a LaziRouter usando estas configuraciones:

**LaziRouter local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de LaziRouter (cc/*, cx/*, glm/*, etc.)
```

**LaziRouter en la nube:**
```
Base URL: https://lazirouter.com/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de LaziRouter (cc/*, cx/*, glm/*, etc.)
```
...
**Problema:** No se puede conectar a LaziRouter
```bash
# Verifica si LaziRouter está corriendo
...
**Solución:**
- Verifica que LaziRouter esté corriendo
...
- Verifica la conexión de red a LaziRouter
