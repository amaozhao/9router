...
開発と個人利用のため、ローカルマシンでLaziRouterを実行。

---

## 📦 インストール

npm経由でLaziRouterをグローバルインストール:
...
LaziRouterが実行されているターミナルで `Ctrl+C` を押します。

```bash
# lazirouterを実行しているターミナル
^C  # Ctrl+Cを押す
```
