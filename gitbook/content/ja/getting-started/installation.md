...
トラブルシューティングのヒント付きのLaziRouter詳細インストールガイド。
...
どこからでも使用できるようにLaziRouterをグローバルインストール:
...
**利点:**
- ✅ どのディレクトリからでも実行
- ✅ シンプルなコマンド: `lazirouter`
- ✅ `npm update -g lazirouter` で自動更新
