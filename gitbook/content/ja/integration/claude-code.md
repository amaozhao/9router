...
LaziRouterをClaude Code CLIと統合し、AnthropicのAPIリクエストをLaziRouterのインテリジェントルーティングシステム経由でルーティングします。
...
Claude CodeはLaziRouterモデルにマッピングされる以下のモデルエイリアスをサポート:
...
1. モデル名がLaziRouterの設定と一致しているか確認
