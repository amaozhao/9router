...
Chạy LaziRouter trên máy cá nhân để phát triển và dùng cá nhân.

---

## 📦 Cài đặt

Cài đặt LaziRouter toàn cục qua npm:
...
Khởi động LaziRouter với một lệnh duy nhất:
...
Nhấn `Ctrl+C` trong terminal đang chạy LaziRouter.
