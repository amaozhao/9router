...
Những câu hỏi phổ biến về LaziRouter.

---

## LaziRouter là gì?

**LaziRouter là bộ định tuyến mô hình AI giúp tối đa hóa giá trị subscription và giảm chi phí.**
...
**LaziRouter dùng chiến lược pricing 3 tầng:**
...
## LaziRouter có miễn phí không?

**Có, LaziRouter hoàn toàn miễn phí và mã nguồn mở 100%.**
...
**Có! Đây là tính năng cốt lõi của LaziRouter.**
...
**LaziRouter theo dõi quota thời gian thực cho tất cả provider:**
...
## Tôi có thể self-host LaziRouter không?

**Có! LaziRouter hỗ trợ nhiều tùy chọn deployment:**
...
- `DATA_DIR` - Đường dẫn lưu database (mặc định: `~/.lazirouter`)
...
**Có, LaziRouter ưu tiên bảo mật và quyền riêng tư:**

**Local storage:**
- Mọi dữ liệu lưu cục bộ tại `~/.lazirouter` (hoặc `DATA_DIR` tùy chỉnh)
- Không gửi data đến server LaziRouter
...
## Làm thế nào để cập nhật LaziRouter?
...
**Breaking changes:**
- Xem [CHANGELOG.md](https://github.com/decolua/lazirouter/blob/main/CHANGELOG.md)
- Backup `~/.lazirouter` trước khi update lớn
...
Xem [CONTRIBUTING.md](https://github.com/decolua/lazirouter/blob/main/CONTRIBUTING.md) để biết chi tiết.

---

## Cần trợ giúp thêm?

- **Documentation:** [lazirouter.com/docs](https://lazirouter.com/docs)
