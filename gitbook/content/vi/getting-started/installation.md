...
Hướng dẫn cài đặt chi tiết cho LaziRouter với mẹo troubleshooting.
...
Cài LaziRouter toàn cục để dùng ở bất kỳ đâu:

```bash
npm install -g lazirouter
```

**Khởi động LaziRouter:**
...
**Lợi ích:**
- ✅ Chạy từ mọi thư mục
- ✅ Lệnh đơn giản: `lazirouter`
- ✅ Auto-update với `npm update -g lazirouter`
...
3. Data directory được tạo tại `~/.lazirouter`
...
**Vấn đề:** LaziRouter dùng quá nhiều RAM
...
# Delete lazirouter-related exports
```
