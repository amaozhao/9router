...
Tích hợp LaziRouter với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- LaziRouter API key từ [dashboard](https://lazirouter.com/dashboard)
- LaziRouter đang chạy (cục bộ hoặc cloud)
...
### 2. Thêm Cấu hình Model LaziRouter
...
3. Chọn model LaziRouter ưa thích
...
- Kiểm tra LaziRouter đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến LaziRouter
