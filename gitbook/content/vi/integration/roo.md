...
Tích hợp LaziRouter với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model LaziRouter có sẵn:
...
### Connection Failed
- Xác minh LaziRouter đang chạy: `curl http://localhost:20128/health`
