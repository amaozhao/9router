...
Các vấn đề và giải pháp phổ biến khi dùng LaziRouter.
...
1. **Auto-refresh (mặc định):**
   LaziRouter tự refresh tokens. Đợi 30 giây rồi thử lại.
...
**Nguyên nhân:**
- LaziRouter không chạy
- Port 20128 bị chặn
- Firewall chặn kết nối

**Giải pháp:**

1. **Khởi động LaziRouter:**
   ```bash
   lazirouter
   ```
...
1. **Kiểm tra LaziRouter có chạy không:**
   ```bash
   # Check process
