 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what lazirouter needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a lazirouter
...
/**
 * Detect whether a model id refers to a lazirouter synthetic agentic variant.
...
/**
 * Detect whether a model id is a lazirouter synthetic thinking variant
...
/**
 * Resolve a lazirouter model id to the real upstream Kiro model id, plus flags
