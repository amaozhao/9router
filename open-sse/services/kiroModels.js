 ...
 * into lazirouter-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are lazirouter fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic lazirouter variant set for a single upstream Kiro model.
 *
 ...
 * into lazirouter variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
