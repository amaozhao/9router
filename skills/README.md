# LaziRouter — Agent Skills

Drop-in skills for any AI agent (Claude, Cursor, ChatGPT, custom SDK). Just **copy a link** below and paste it to your AI — it will fetch the skill and use LaziRouter for you.

> Tip: start with the **lazirouter** entry skill — it covers setup and links to all capability skills.

## Skills

| Capability | Copy link below and paste to your AI |
|---|---|
| **Entry / Setup** (start here) | https://raw.githubusercontent.com/decolua/lazirouter/refs/heads/master/skills/lazirouter/SKILL.md |
...
```
Read this skill and use it: https://raw.githubusercontent.com/decolua/lazirouter/refs/heads/master/skills/lazirouter/SKILL.md
```
...
- Source: https://github.com/decolua/lazirouter
- Dashboard: https://lazirouter.com
