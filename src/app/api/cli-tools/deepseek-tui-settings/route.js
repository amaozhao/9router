...
const PROVIDER_NAME = "lazirouter";
...
// Build TOML config for LaziRouter (openai provider mode)
const buildLaziRouterConfig = (baseUrl, apiKey, model) => {
...
// Detect LaziRouter by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildLaziRouterConfig(baseUrl, apiKey || "sk_lazirouter", model);
